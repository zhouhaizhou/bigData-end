...
namespace WcfSmcGridService.SYS.BigData
{
    ...
    public interface IHomeDataService
    {
        ...
        [WebInvoke(Method = "GET",
          ...
          ResponseFormat = WebMessageFormat.Json,
          BodyStyle = WebMessageBodyStyle.Bare,
          UriTemplate = "InsertQuestionData?submitData={submitData}&starLevel={starLevel}"
        )]
        string InsertQuestionData(string submitData, string starLevel);
        ...
        [WebInvoke(Method = "GET",
          ...
          ResponseFormat = WebMessageFormat.Json,
          BodyStyle = WebMessageBodyStyle.Bare,
          UriTemplate = "GetQuestionData?starLevel={starLevel}"
        )]
        string GetQuestionData(string starLevel);
        ...
        [WebInvoke(Method = "GET",
          ...
          ResponseFormat = WebMessageFormat.Json,
          BodyStyle = WebMessageBodyStyle.Bare,
          UriTemplate = "ShowQuestionnaire?starLevel={starLevel}&account={account}"
        )]
        string ShowQuestionnaire(string starLevel,string account);
