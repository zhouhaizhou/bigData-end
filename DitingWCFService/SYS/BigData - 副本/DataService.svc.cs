...
namespace WcfSmcGridService.SYS.BigData
{
    ...
    public class DataService : IDataService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string getSubTitle(string moduleEnName)
        {
            try
            {
                return JsonHelper.ToJSON(dsImpl.getSubTitle(moduleEnName));
            }
            catch (Exception ex)
            {
        ...
        /// <returns></returns>
        public string GetModuleByParentModule(string parentModule, string roldId)
        {
            try
            {
                return JsonHelper.ToJSON(dsImpl.GetModuleByParentModule(parentModule,roldId));
            }
            catch (Exception ex)
            {
